 ...
 * Fungsi: Komponen header untuk layout guru bidang studi dengan indikator tahun ajaran.
...
/* Komponen Utama: Header untuk Guru Bidang Studi */
export default function Header({ user: initialUser }: HeaderProps) {
    ...
    useEffect(() => {
        const fetchTahunAjaran = async () => {
            try {
                ...
                const res = await fetch(`${API_BASE_URL}/api/guru-bidang-studi/tahun-ajaran/aktif`, {
    ...
    const handleUbahPassword = () => { 
        setDropdownOpen(false); 
        router.push('/guru_bidang_studi/ubah_password'); 
    };
