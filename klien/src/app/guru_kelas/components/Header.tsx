 ...
 * UPDATE: Tampilan disamakan dengan Header Guru Bidang Studi + efek kilau bergerak
 *         pada bar header (sama seperti Header Admin)
...
const GlobalStyles = () => (
    <style jsx global>{`
        ...
        /* Kilau bergerak di sepanjang bar header orange (sama seperti Header Admin) */
        .gk-bar-shimmer {
            position: absolute;
            top: -50%;
            left: -60%;
