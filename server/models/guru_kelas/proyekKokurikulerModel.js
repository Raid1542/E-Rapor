...
const proyekKokurikulerModel = {
    /**
     * Ambil judul proyek berdasarkan kelas dan tahun ajaran.
     */
    async getJudulProyekByKelas(kelasId, tahunAjaranId) {
     ...
     */
    async saveJudulProyek(kelasId, tahunAjaranId, judul) {
     ...
     * Hapus judul proyek.
     */
    async deleteJudulProyek(kelasId, tahunAjaranId) {
        if (!kelasId || !tahunAjaranId) {
            throw new Error('ID kelas dan tahun ajaran wajib diisi');
        }
...
module.exports = proyekKokurikulerModel;