...
const guruModel = {
  /**
   * Ambil semua data guru (guru_kelas & guru_bidang_studi).
   */
  async getAllGuru() {
    try {
  ...
  /**
   * Buat guru baru (user + guru + roles) dalam satu transaksi.
   */
    ...
    try {
      ...
      await connection.execute(
        ...
        [
          ...
          guruData.tanggal_lahir || null, guruData.jenis_kelamin || null,
          guruData.alamat || null, guruData.no_telepon || null
        ]
      );
      ...
      throw new Error('Gagal membuat data guru');
    } finally {
      connection.release();
    }
  },
  ...
  /**
   * Update data guru (user + guru + roles) dalam satu transaksi.
   */
    ...
    try {
      ...
      if (guruExists.length > 0) {
        await connection.execute(
          ...
          [
            guruData.niy || null, guruData.nuptk || null, guruData.tempat_lahir || null,
            guruData.tanggal_lahir || null, guruData.jenis_kelamin || null,
            guruData.alamat || null, guruData.no_telepon || null, id
          ]
        );
      } else {
        await connection.execute(
          ...
          [
            id, guruData.niy || null, guruData.nuptk || null, guruData.tempat_lahir || null,
            guruData.tanggal_lahir || null, guruData.jenis_kelamin || null,
            guruData.alamat || null, guruData.no_telepon || null
          ]
        );
