...
// Middleware: cek penugasan guru ke mapel di kelas tertentu dan inject req.penugasanGuru
const cekAksesMapelDanKelas = async (req, res, next) => {
    try {
        ...
        // Cek penugasan guru ke mapel di kelas tertentu
        ...
        if (rows.length === 0) {
            return res.status(403).json({
                success: false,
                message: 'Anda tidak mengajar mapel ini di kelas tersebut semester ini.',
