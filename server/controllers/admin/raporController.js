 ...
 * Fungsi: Controller untuk manajemen rapor siswa (arsip, status penilaian, data rapor).
 *         Menangani arsip rapor per semester, atur status PTS/PAS, dan pengambilan data rapor lengkap.
 ...
 * @param {string} semester - Nama semester (Ganjil/Genap)
 ...
 * @param {number} taId - ID tahun ajaran (semester)
 * @param {string} semester - Nama semester
 * @param {string} jenis - Jenis penilaian (PTS/PAS)
 * @returns {Object} Data rapor lengkap
 */
 ...
 * Ambil daftar semua tahun ajaran untuk dropdown.
 */
...
/**
 * GET /api/admin/arsip-rapor/kelas
 * Ambil daftar kelas berdasarkan tahun ajaran dan semester.
 * 
 * @param {string} req.query.tahun_ajaran_id - ID tahun ajaran induk
 * @param {string} req.query.semester - Nama semester (opsional)
 */
...
/**
 * GET /api/admin/arsip-rapor/daftar-siswa
 * Ambil daftar siswa untuk arsip rapor berdasarkan kelas dan semester.
 * 
 * @param {number} req.tahunAjaranId - ID tahun ajaran induk (dari middleware)
 * @param {number} req.kelasId - ID kelas (dari middleware)
 * @param {string} req.query.semester - Nama semester (Ganjil/Genap)
 */
...
/**
 * POST /api/admin/atur-status-penilaian
 * Atur status penilaian PTS atau PAS (aktif/nonaktif/selesai).
 * 
 * Business Rules:
 *   - PTS dan PAS tidak boleh aktif bersamaan
 *   - PAS hanya bisa dibuka setelah PTS selesai
 *   - PTS tidak bisa dibuka jika PAS sudah selesai
 * 
 * @param {string} req.body.jenis - PTS atau PAS
 * @param {string} req.body.status - aktif, nonaktif, atau selesai
 * @param {number} req.body.tahun_ajaran_id - ID tahun ajaran induk
 * @param {string} req.body.semester - Ganjil atau Genap
 */
...
/**
 * POST /api/admin/arsipkan-rapor
 * Arsipkan rapor semua siswa untuk semester tertentu.
 * Data rapor disimpan dalam format JSON di tabel arsip_rapor.
 * Setelah arsip, status penilaian diubah menjadi 'selesai' (locked).
 * 
 * @param {string} req.body.jenis - PTS atau PAS
 * @param {string} req.body.semester - Ganjil atau Genap
 * @param {number} req.body.tahun_ajaran_id - ID tahun ajaran induk
