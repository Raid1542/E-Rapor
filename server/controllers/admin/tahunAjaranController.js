        ...
        if (statusCheck.length > 0) {
            ...
            if (lockedFields.length > 0) {
                return res.status(403).json({
                    success: false,
                    message: `Tidak dapat mengubah tanggal ${lockedFields.join(
                        ', '
                    )} karena penilaian sudah diarsipkan dan dikunci.`,
                });
            }
        }
    ...
    try {
        ...
        try {
            ...
            if (infoNilai.total_siswa === 0) {
                ...
                catatan =
                    'Data nilai sebelumnya masih tersimpan, guru dapat melanjutkan input di semester yang baru.';
            }
