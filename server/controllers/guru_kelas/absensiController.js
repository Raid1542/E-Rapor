 ...
 * Fungsi: Controller absensi siswa guru kelas (PTS/PAS)
...
exports.getAbsensiSiswa = async (req, res) => {
    try {
        ...
        console.log('GET absensi - Request:', { userId, jenis, semester, infoKelasWali: req.infoKelasWali });
        ...
        console.log('Processed:', { kelasId, namaKelas, tahunAjaranId, idInduk: req.idTahunAjaranInduk });
 ...
 * Simpan/update absensi siswa untuk PTS atau PAS.
 * Validasi: tidak negatif, max 90 hari, PAS >= PTS.
 */
