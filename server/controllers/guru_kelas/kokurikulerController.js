...
/**
 * GET /api/guru-kelas/kokurikuler
 * Ambil nilai kokurikuler semua siswa di kelas + auto-hitung grade dari konfigurasi
 */
exports.getNilaiKokurikuler = async (req, res) => {
    try {
        ...
        // Ambil kelas yang diampu guru (pakai semesterId)
        ...
        // Ambil konfigurasi grade untuk auto-kalkulasi
        ...
        // Helper untuk cari grade berdasarkan nilai
        ...
        nilaiRows.forEach(row => {
            ...
            // Auto-kalkulasi jika grade/deskripsi kosong di DB
...
/**
 * GET /api/guru-kelas/kokurikuler/:siswaId
 * Ambil detail nilai kokurikuler untuk satu siswa tertentu
 */
...
/**
 * PUT /api/guru-kelas/kokurikuler/:siswaId
 * Simpan/Update nilai kokurikuler. 
 * Business Rules: PTS hanya boleh isi Mutaba'ah. PAS boleh isi semua.
 */
exports.updateNilaiKokurikuler = async (req, res) => {
    try {
        ...
        // Auto-kalkulasi grade & deskripsi jika tidak dikirim dari frontend
...
/**
 * GET /api/guru-kelas/proyek/judul
 * Ambil judul proyek kokurikuler untuk kelas yang diampu
 */
...
/**
 * POST /api/guru-kelas/proyek/judul
 * Simpan judul proyek. Hanya bisa dilakukan saat PAS aktif.
 */
exports.saveJudulProyek = async (req, res) => {
    try {
        const { judul } = req.body;
        const userId = req.user.id;
        const { status_pas } = req.penilaianContext || {};

        // Validasi periode (Hanya PAS)
        if (status_pas !== 'aktif') {
